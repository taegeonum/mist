...
public final class TestLogger {
  ...
  public AtomicLong getExecutionDagGenerationTime() {
    return executionDagGenerationTime;
  }

  public AtomicLong getSourceStartTime() {
  ...
  public void print() {
    ...
    System.out.println("!!Query creation time (w/o merging): " +
        TimeUnit.NANOSECONDS.toMillis(queryCreationTime.get()));
