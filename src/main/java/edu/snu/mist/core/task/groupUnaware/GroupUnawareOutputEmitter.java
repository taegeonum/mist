 ...
 */
package edu.snu.mist.core.task.groupUnaware;
 ...
 *  @param <I>
 */
public final class GroupUnawareOutputEmitter<I> implements OutputEmitter {
  ...
  public GroupUnawareOutputEmitter(final Map<ExecutionVertex, MISTEdge> nextOperators,
